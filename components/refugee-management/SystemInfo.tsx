...
const SystemInfo = () => {
  return (
    <div className="w-full bg-white flex justify-center items-center p-24 px-60">
      <div className='w-[80%]'>
        <h1 className="font-normal text-xl text-center mb-4">UGANDA REFUGEE RESPONSE MONITORING E-SYSTEM</h1>
