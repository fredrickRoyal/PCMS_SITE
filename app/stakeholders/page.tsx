...
accordionData = [
  {
    ...
    nodeComponent: (
      <div className="flex flex-col gap-4">
        {" "}
        <p>
          The Office of the United Nations High Commissioner for Refugees is a
          United Nations programme with the mandate to protect refugees,
          forcibly displaced communities and stateless people, and assist in
          their voluntary repatriation, local integration or resettlement to a
          third country
        </p>
        <p>
          It raises resources to support Government to manage refugees in
          realising durable solutions, in addition it monitors and coordinates
          those services that they deliver through specific NGOs, ensuring
          adherence to international standards on refugees’ matters.
        </p>
      </div>
    ),
  },
  {
    ...
    description:
      "The Act establishes the Refugee Management Authority (RMA) and sets out the mandate for the RMA.",
    imageSrc: "/blog2.jpeg",
  },
  {
    id: "3",
    ...
    description:
      "The Act establishes the Refugee Hosting Authority (RHA) and sets out the mandate for the RHA.",
    imageSrc: "/blog3.jpeg",
  },
  {
    id: "4",
    title: "THE REFUGEES",
    description:
      "The Universal Declaration of Human Rights is a landmark international treaty that outlines fundamental human rights for all people. It serves as a guiding principle for international cooperation and peacekeeping efforts.",
    imageSrc: "/blog4.jpeg",
  },
  {
    id: "5",
